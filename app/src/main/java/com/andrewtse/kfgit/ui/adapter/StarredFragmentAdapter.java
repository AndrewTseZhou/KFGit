...
public class StarredFragmentAdapter extends BaseQuickAdapter<StarredModel, CustomViewHolder> {
    ...
    protected void convert(CustomViewHolder holder, StarredModel item) {
        ...
        holder.setSelected(R.id.iv_star_state, true)
              ...
              .setText(R.id.tv_starred_count, StringUtils.getCount(item.getStargazersCount()))
              .setText(R.id.tv_forks_count, StringUtils.getCount(item.getForksCount()))
              .addOnClickListener(R.id.iv_star_state)
              .addOnClickListener(R.id.tv_starred_count);
    }
}
