...
public class SearchPresenter extends BasePresenterImpl<ISearchContract.ISearchView> {
    ...
    private final SearchApi mSearchRepoApi;

    @Inject
    Application mContext;

    @Inject
    public SearchPresenter(SearchApi searchRepoApi) {
        mSearchRepoApi = searchRepoApi;
    }

    public void getSearchResult(String q, int page, int perPage, int type) {
        mSearchRepoApi.getSearchResult(q, page, perPage, type)
